...
<head>
  ...
  <title>AdminLTE 3 | Dashboard</title>
   ...
   <!-- DataTables -->
   <link rel="stylesheet" href="assets-template/plugins/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="assets-template/plugins/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="assets-template/plugins/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <a href="logout.php" class="nav-link">
              <i class="nav-icon fas fa-sign-out-all"></i>
              <p>
                Logout
              </p>
            </a>
